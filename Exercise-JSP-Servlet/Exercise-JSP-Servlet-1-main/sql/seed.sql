...
-- ID 3
(3,'vi','Laptop'),    (3,'en','Laptops'), (3,'ja','ノートPC'), (3,'fr','Ordinateurs portables'),
-- ID 4
...
(7,'fr','Ordinateur portable L5','Core i5, 16 Go de RAM, SSD 512 Go'),
...
(8,'fr','Ordinateur portable Pro 14','Core i7, écran Retina 14"'),
...
(9,'fr','Ordinateur portable Gamer Z','RTX 4060, écran 15,6" 144Hz'),
