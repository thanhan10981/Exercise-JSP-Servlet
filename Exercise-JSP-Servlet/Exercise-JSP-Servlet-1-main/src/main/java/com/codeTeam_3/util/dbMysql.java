...
public final class dbMysql {
    ...
    static {
        ...
        cfg.setJdbcUrl(System.getenv().getOrDefault(
                "DB_URL",
                "jdbc:sqlserver://localhost:1433;databaseName=team3;encrypt=false"
        ));
        cfg.setUsername(System.getenv().getOrDefault("DB_USER", "sa"));
        cfg.setPassword(System.getenv().getOrDefault("DB_PASS", "123"));
